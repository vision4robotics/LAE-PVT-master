...
def parse_args():
    ...
    parser.add_argument('--raw_root', default='/home/li/sAP-master/pysot-master/tools/results_rt_raw/UAVDT',type=str,
        help='raw result root')
    parser.add_argument('--tar_root', default='/home/li/sAP-master/pysot-master/tools/results_rt/UAVDT',type=str,
        help='target result root')
    parser.add_argument('--gtroot',default='/media/li/CA5CF8AE5CF89683/research/UAVDT/anno', type=str)
...
def main():
    ...
    for tracker in trackers:        
        ...
        for gt_idx, video in enumerate(gt_list):
            ...
            gtlen = len(open(join(gt_path,video)).readlines())
