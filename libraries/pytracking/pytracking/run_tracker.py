...
def main():
    ...
    parser.add_argument('--dataset_name', type=str, default='uav10fps', help='Name of dataset (otb, nfs, uav, tpl, vot, tn, gott, gotv, lasot).')
    ...
    run_tracker(args.tracker_name, args.tracker_param, args.runid, args.dataset_name, seq_name, args.debug,
                args.threads, {'use_visdom': args.use_visdom, 'server': args.visdom_server, 'port': args.visdom_port}, args.rt_running)
