...
parser.add_argument('--dataset', default='DTB70',type=str,
        help='datasets')
parser.add_argument('--datasetroot', default='/media/C8F6-C657/DTB70/',type=str,
        help='datasetsroot')
parser.add_argument('--fps', default=30,type=int,
        help='input frame rate')
parser.add_argument('--config', default='/home/v4r/LBW/streaming_object_tracking/pysot-master/experiments/siamrpn_mobilev2_l234_dwxcorr/config1.yaml', type=str,
        help='config file')
parser.add_argument('--snapshot', default='/home/v4r/LBW/streaming_object_tracking/pysot-master/experiments/siamrpn_mobilev2_l234_dwxcorr/model.pth', type=str,
